...
<body>
    <form enctype="multipart/form-data" id="PostMe" method="post" name="upform">
        ...
        <div class="uploadpic">
		<img id="ImgPr" src="<?php if($Img == ''): ?>/webGuangHui/Public/qwadmin/images/nopic.gif<?php else: ?>/webGuangHui<?php echo ($Img); endif; ?>"  width="<?php echo ($Width); ?>" height="<?php echo ($Height); ?>">
