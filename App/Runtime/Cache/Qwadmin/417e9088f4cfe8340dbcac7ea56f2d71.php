...
<head>
    ...
    <link rel="stylesheet" href="/webGuangHui/Public/qwadmin/css/bootstrap.css"/>
    <link rel="stylesheet" href="/webGuangHui/Public/qwadmin/css/font-awesome.css"/>
    <link rel="stylesheet" href="/webGuangHui/Public/qwadmin/css/jquery-ui.css"/>
    <!-- page specific plugin styles -->

    <!-- text fonts -->
    <link rel="stylesheet" href="/webGuangHui/Public/qwadmin/css/ace-fonts.css"/>

    <!-- ace styles -->
    <link rel="stylesheet" href="/webGuangHui/Public/qwadmin/css/ace.css" class="ace-main-stylesheet" id="main-ace-style"/>

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="/webGuangHui/Public/qwadmin/css/ace-part2.css" class="ace-main-stylesheet"/>
    <![endif]-->

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="/webGuangHui/Public/qwadmin/css/ace-ie.css"/>
    ...
    <script src="/webGuangHui/Public/qwadmin/js/ace-extra.js"></script>

    <!-- HTML5shiv and Respond.js for IE8 to support HTML5 elements and media queries -->

    <!--[if lte IE 8]>
    <script src="/webGuangHui/Public/qwadmin/js/html5shiv.js"></script>
    <script src="/webGuangHui/Public/qwadmin/js/respond.js"></script>
    <![endif]-->
</head>
<body class="no-skin">
                ...
                <ul class="nav ace-nav">
                    ...
                    <li class="light-blue">
                        <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                            <img class="nav-user-photo" src="<?php if( $user["head"] == '' ): ?>/webGuangHui/Public/qwadmin/avatars/avatar2.png
                            <?php else: ?>
                            /webGuangHui<?php echo ($user["head"]); endif; ?>" alt="<?php echo ($user["user"]); ?>" />
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" id="form" method="post" action="<?php echo U('update');?>">
                            ...
                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="name"> 文章名称 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="name" id="name" placeholder="分类名称"
                                           class="col-xs-10 col-sm-5" value="<?php echo ($currentcategory["name"]); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">文章名称，不能为空。</span>
											</span>
                                </div>
                            </div>
                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="dir"> 文章路径 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="dir" id="dir" placeholder="请输入文章路径如: './news/news.html'  (不包含单引号及空格) "
                                           class="col-xs-10 col-sm-5" value="<?php echo ($currentcategory["dir"]); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">文章路径，不能为空。</span>
											</span>
                                </div>
                            </div>
                            <div class="space-4"></div>
...
<!--[if !IE]> -->
<script type="text/javascript">
    window.jQuery || document.write("<script src='/webGuangHui/Public/qwadmin/js/jquery.js'>" + "<" + "/script>");
</script>
...
<!--[if IE]>
<script type="text/javascript">
    window.jQuery || document.write("<script src='/webGuangHui/Public/qwadmin/js/jquery1x.js'>" + "<" + "/script>");
</script>
<![endif]-->
<script type="text/javascript">
    if ('ontouchstart' in document.documentElement) document.write("<script src='/webGuangHui/Public/qwadmin/js/jquery.mobile.custom.js'>" + "<" + "/script>");
</script>
<script src="/webGuangHui/Public/qwadmin/js/bootstrap.js"></script>

<!-- page specific plugin scripts -->
<script charset="utf-8" src="/webGuangHui/Public/kindeditor/kindeditor-min.js"></script>
<script charset="utf-8" src="/webGuangHui/Public/kindeditor/lang/zh_CN.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/bootbox.js"></script>
<!-- ace scripts -->
<script src="/webGuangHui/Public/qwadmin/js/ace/elements.scroller.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/elements.colorpicker.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/elements.fileinput.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/elements.typeahead.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/elements.wysiwyg.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/elements.spinner.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/elements.treeview.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/elements.wizard.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/elements.aside.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/ace.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/ace.ajax-content.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/ace.touch-drag.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/ace.sidebar.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/ace.sidebar-scroll-1.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/ace.submenu-hover.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/ace.widget-box.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/ace.settings.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/ace.settings-rtl.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/ace.settings-skin.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/ace.widget-on-reload.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/ace/ace.searchbox-autocomplete.js"></script>
<script src="/webGuangHui/Public/qwadmin/js/jquery-ui.js"></script>
<!-- inline scripts related to this page -->
<script type="text/javascript">
    $(function () {
        var editor = KindEditor.create('textarea[name="content"]', {
            uploadJson: '/webGuangHui/Public/kindeditor/php/upload_json.php',
            fileManagerJson: '/webGuangHui/Public/kindeditor/php/file_manager_json.php',
